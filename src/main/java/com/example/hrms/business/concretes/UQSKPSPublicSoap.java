...
public class UQSKPSPublicSoap
{
    ...
    public UQSKPSPublicSoap(){}

    public UQSKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public UQSKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        UQSExtendedSoapSerializationEnvelope envelope= new UQSExtendedSoapSerializationEnvelope(UQSExtendedSoapSerializationEnvelope.VER11);
